var BookDetail = {
    ...
    SetWholeTip: function () {
        ...
        str += '<li>2、コインを支払うと有料話を読めます。コインがない場合は先にチャージしてください。</li>';
        str += '<li>3、QQ・WeChat・Weiboの3つのアカウント間でデータは連携されません。チャージが成功したのにコインが反映されない場合は、他のアカウントにチャージされていないか確認してください。</li>';
