...
var HeaderShowUtil = {
    headerShowHistory: function (obj) {
        if ($("#headerUserHistory").html().length < 10) {
            ...
            rStr += '					<div class="record_title" id="hdShowTitle"><a href="javascript:void(0);" class="record_tit1 on" onclick="javascript:HeaderShowUtil.headerShowHistoryLog(this);">最近読んだ本</a><a href="javascript:void(0);" class="record_tit2" onclick="javascript:HeaderShowUtil.headerShowFavLog(this);">マイ本棚</a></div>';
            rStr += '					<div class="record_list record_list1" id="hdShowHistory">';
            rStr += '						<ul>';
            rStr += '						</ul>';
            rStr += '						<a class="all" href="/" >すべて見る</a>';
            rStr += '					</div>';
    ...
    headerShowHistoryLog: function (obj) {
        ...
        if (cookieHistory != undefined && cookieHistory.length > 0) {
            ...
            $("#hdShowHistory ul").html("<li>閲覧履歴はありません</li>");
        }
    },
    headerShowFavLog: function (obj) {
        ...
        if (uname != undefined && uname != "") {
            ...
            rStr = '<li><a href="/user/login.html">ログインしてください</a></li>';
